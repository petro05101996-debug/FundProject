...
INSTRUMENT_CATALOG = {
    ...
    "Облигационный фонд": {
        ...
        "liquidity_score": 4,
        "complexity_score": 3,
        "horizon": "средний горизонт",
        "checks": ["комиссия фонда", "дюрация портфеля", "волатильность", "ликвидность", "налог"],
    },
    "Акция как класс": {
        "asset_class": "Акции",
        "risk_score": 5,
        ...
        "checks": ["волатильность", "концентрация", "дивиденды", "налог", "доля в сценарии"],
    },
    "ИИС": {
        "asset_class": "Налоговый режим",
        "risk_score": 2,
        "liquidity_score": 2,
        "complexity_score": 3,
        "horizon": "от 3 лет",
        "checks": ["тип вычета", "срок владения", "налоговые условия", "ограничения пополнения"],
    },
    "ПДС": {
        "asset_class": "Пенсионный сценарий",
        "risk_score": 2,
        "liquidity_score": 1,
        "complexity_score": 4,
        "horizon": "длинный горизонт",
        "checks": ["срок участия", "условия софинансирования", "налоги", "правила досрочного выхода"],
    },
    "Индексный фонд": {
        "asset_class": "Акции",
        "risk_score": 4,
